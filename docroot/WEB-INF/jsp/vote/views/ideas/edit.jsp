...
<aui:form action="${editIdeaURL}" method="post">
	<portlet:renderURL var="viewIdeaURL">
		<portlet:param name="controller" value="ideas" />
		<portlet:param name="action" value="index" />
	</portlet:renderURL>

	<aui:input name="redirect" type="hidden" value="${viewIdeaURL}" />
	<aui:input name="id" type="hidden" value="${voteIdea.voteIdeaId}" />
	...
	<aui:button-row>
		...
		<aui:button href="${viewIdeaURL}" value="cancel" />
	</aui:button-row>
</aui:form>