...
/**
 * Provides the local service interface for VoteIdea. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Howie Chou
 * @see VoteIdeaLocalServiceUtil
...
public interface VoteIdeaLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VoteIdeaLocalServiceUtil} to access the vote idea local service. Add custom service methods to {@link com.liferay.vote.service.impl.VoteIdeaLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
