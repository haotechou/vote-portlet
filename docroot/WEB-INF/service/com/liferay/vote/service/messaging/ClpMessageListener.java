...
package com.liferay.vote.service.messaging;
...
public class ClpMessageListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			VoteBallotLocalServiceUtil.clearService();

			VoteEntryLocalServiceUtil.clearService();

			VoteIdeaLocalServiceUtil.clearService();

			VoteIdeaTypeLocalServiceUtil.clearService();
		}
	}
}