...
/**
 * Provides the local service interface for VoteBallot. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Howie Chou
 * @see VoteBallotLocalServiceUtil
...
public interface VoteBallotLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VoteBallotLocalServiceUtil} to access the vote ballot local service. Add custom service methods to {@link com.liferay.vote.service.impl.VoteBallotLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
