 ...
 * @author Howie Chou
 */
public class VoteBallotClp extends BaseModelImpl<VoteBallot>
	implements VoteBallot {
	public VoteBallotClp() {
	}
	...
	public void setVoteBallotId(long voteBallotId) {
		...
		if (_voteBallotRemoteModel != null) {
			try {
				Class<?> clazz = _voteBallotRemoteModel.getClass();

				Method method = clazz.getMethod("setVoteBallotId", long.class);

				method.invoke(_voteBallotRemoteModel, voteBallotId);
			}
			catch (Exception e) {
	...
	public void setCompanyId(long companyId) {
		...
		if (_voteBallotRemoteModel != null) {
			try {
				...
				method.invoke(_voteBallotRemoteModel, companyId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setUserId(long userId) {
		...
		if (_voteBallotRemoteModel != null) {
			try {
				...
				method.invoke(_voteBallotRemoteModel, userId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setUserName(String userName) {
		...
		if (_voteBallotRemoteModel != null) {
			try {
				...
				method.invoke(_voteBallotRemoteModel, userName);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setCreateDate(Date createDate) {
		...
		if (_voteBallotRemoteModel != null) {
			try {
				...
				method.invoke(_voteBallotRemoteModel, createDate);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setModifiedDate(Date modifiedDate) {
		...
		if (_voteBallotRemoteModel != null) {
			try {
				...
				method.invoke(_voteBallotRemoteModel, modifiedDate);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setVoteIdeaTypeId(long voteIdeaTypeId) {
		...
		if (_voteBallotRemoteModel != null) {
			try {
				...
				method.invoke(_voteBallotRemoteModel, voteIdeaTypeId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setName(String name) {
		...
		if (_voteBallotRemoteModel != null) {
			try {
				...
				method.invoke(_voteBallotRemoteModel, name);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setDescription(String description) {
		...
		if (_voteBallotRemoteModel != null) {
			try {
				...
				method.invoke(_voteBallotRemoteModel, description);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setEndDate(Date endDate) {
		...
		if (_voteBallotRemoteModel != null) {
			try {
				...
				method.invoke(_voteBallotRemoteModel, endDate);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public BaseModel<?> getVoteBallotRemoteModel() {
		return _voteBallotRemoteModel;
	}

	public void setVoteBallotRemoteModel(BaseModel<?> voteBallotRemoteModel) {
		_voteBallotRemoteModel = voteBallotRemoteModel;
	}
	...
	public Object invokeOnRemoteModel(String methodName,
		...
		Class<?> remoteModelClass = _voteBallotRemoteModel.getClass();
		...
		Object returnValue = method.invoke(_voteBallotRemoteModel,
	...
	public VoteBallot toEscapedModel() {
		return (VoteBallot)ProxyUtil.newProxyInstance(VoteBallot.class.getClassLoader(),
			new Class[] { VoteBallot.class }, new AutoEscapeBeanHandler(this));
	}

	@Override
	public Object clone() {
		VoteBallotClp clone = new VoteBallotClp();
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof VoteBallotClp)) {
			return false;
		}

		VoteBallotClp voteBallot = (VoteBallotClp)obj;
	...
	private BaseModel<?> _voteBallotRemoteModel;
